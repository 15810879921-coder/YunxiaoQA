...
class YunxiaoCliTestLifecycleTests(unittest.TestCase):
    ...
    def test_start_preflight_requires_deployment_validation(self) -> None:
        test = {
        ...
        with tempfile.TemporaryDirectory() as folder:
            ...
            with patch.object(lifecycle.core, "find_aliyun", return_value="aliyun"), \
                    ...
                    patch.object(lifecycle, "validate_deployment", return_value={"schemaVersion": lifecycle.DEPLOY_SCHEMA}) as validator:
                result = lifecycle.run(args)
        self.assertEqual(result, 0)
        self.assertEqual(args.req_sn, "ONEOS-500")
        validator.assert_called_once_with(test, req, "project")
